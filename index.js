...
function addFlavor(arr,flavor){
	...
	// const extract = originalFlavors.splice(0, 2)  // This method removes. No beueno.
	// console.log("addFlavor -> extract", extract)
	console.log(originalFlavors.length)
	for (i=0;i<3;i++){
...
function getFlavorByIndex(arr,target){
...
function removeFlavorByName(arr,flavor){
		for (i=0;i<arr.length;i++){
			if (arr[i]===flavor) {		// I dont like this function at all.
...
let newArr = []
function copy(arr){  // I cant figure out how to use this second param
	let newArr = [...arr]  // Used the spread operator but I should do with loop also. Omg.
	console.log(newArr.length)  // this returns 0
}
console.log(newArr.length)  // this returns 30
copy(originalFlavors)  // I give up.
