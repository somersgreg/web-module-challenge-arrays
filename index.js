...
// I DIDNT KNOW HOW count EQUALS originalFlavors LENGTH. I DIDNT KNOW THE CONSOLE.LOG ALSO HAD TO BE IN PARENTHESIS.  I DIDNT KNOW TRUE AND FALSE WOULD BE DECLARED IN QUOTES.
...
// I STILL DIDNT INSTINCTIVELY GET THAT THE WAY TO APPLY THE FUNCTION IS TO SIMPLY WRITE IT WITH ITS PARAMETERS.
...
// THIS CONSOLE LOG SAYS [31] AND THE ARRAY
...
// DIDNT KNOW TO NOT CONSOLE LOG IN THE FUNCTION. AND DONT DO IT WITH THE PARAMETER. USE THE ARRAY NAME.  I DIDNT KNOW TO PUT SEMICOLON AFTER ACTIONS BUT NOT LOGIC FUNCTIONS.
...
// console.log(copyArr, originalFlavors);
...
// you wil have to iteratate over the entire array
// ask does .includes that value

function filterByWord(arr, string) {
	newArr = [];
	for (index in arr) {
		if (arr[index].includes(string)) {
